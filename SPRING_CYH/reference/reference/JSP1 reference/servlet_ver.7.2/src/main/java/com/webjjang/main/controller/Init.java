...
import com.webjjang.image.service.ImageLikeCancelService;
import com.webjjang.image.service.ImageLikeService;
...
import com.webjjang.message.controller.AjaxController;
import com.webjjang.message.controller.MessageController;
import com.webjjang.message.dao.MessageDAO;
import com.webjjang.message.service.MessageCountService;
...
public class Init extends HttpServlet {
	...
	private void newAndSave() {
		...
		Beans.put("/message", new MessageController());
		Beans.put("/ajax", new AjaxController());
		...
		Beans.put("/image/like.do", new ImageLikeService());
		Beans.put("/image/likeCancel.do", new ImageLikeCancelService());
		...
		Beans.put("/ajax/msgCount.do", new MessageCountService());
		...
		Beans.put("messageDAO", new MessageDAO());
	}
...
//		Beans.getService("/notice/delete.do").setDao(Beans.getDAO("noticeDAO"));
		...
		Beans.getService("/image/like.do").setDao(Beans.getDAO("imageDAO"));
		Beans.getService("/image/likeCancel.do").setDao(Beans.getDAO("imageDAO"));
		// 회원관리 - 로그인 조립
		Beans.getService("/member/login.do").setDao(Beans.getDAO("loginDAO"));
		// 메시지 조립
		Beans.getService("/message/list.do").setDao(Beans.getDAO("messageDAO"));
		Beans.getService("/message/write.do").setDao(Beans.getDAO("messageDAO"));
		Beans.getService("/message/view.do").setDao(Beans.getDAO("messageDAO"));
		Beans.getService("/ajax/msgCount.do").setDao(Beans.getDAO("messageDAO"));
	}
