<%@page import="com.webjjang.qna.service.QnaAnswerService"%>
<%@page import="com.webjjang.member.vo.LoginVO"%>
<%@page import="com.webjjang.qna.service.QnaUpdateService"%>
...
vo.setId(id);
vo.setRefNo(refNo); // 1차 정렬을 refNo로 하기 때문에 한곳에 모여야 한다.
