...
<body>
   <%-- <form action="<c:url value="/register/save"/>" method="POST" onsubmit="return formCheck(this)"> --%> <!-- 폼 체크 잠시 꺼둠	 -->
   <form:form modelAttribute="user">	<!-- 스프링이 제공하는 태그 -->
	...
	<div id="msg" class="msg"><form:errors path="id"/></div> 
	 ...
	 <%-- <div ig = "msg" class="msg"> ${URLDecoder.decode(param.msg, "utf-8")}</div> --%> 
