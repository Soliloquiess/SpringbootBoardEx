...
//
	...
	////게시글 읽기 -  단일게시판
	@GetMapping("/read")
	public ResponseDto<BoardResponseDto> read(Integer boardNo) throws Exception {
		BoardResponseDto boardResponseDto = new BoardResponseDto();
		boardResponseDto.setBoard(service.read(boardNo));
		boardResponseDto.setBoardAttach(service.readFileList(boardNo));


		ResponseDto<BoardResponseDto> response = new ResponseDto<>();
		response.setData(boardResponseDto);
		return response;
	}
