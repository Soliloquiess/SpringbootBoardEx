...
// 날짜 패턴 검사 -> JS 정규 표현식
// 맨 앞자리는 숫자 4 + "-" + 중간 숫자 2자리:0[1-9], 1[012] + "-" + 뒷자리 2자리 : [12][0-9][3][01]
var reg_date = /^\d{4}-(0[1-9]|1[012])-([0][1-9]|[12][0-9]|3[01])$/;
// 이메일 정규 표현식
// 영숫자 한자리 + [-_.]? - 0 또는 한개 문자 + [0-9a-zA-Z] * 0개 이상 + 
// @ + [0-9a-zA-Z] + ([-_.]?[0-9a-zA-Z])* + . + [a-zA-Z]{2,3} : 2자~3자
var reg_email =  /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i;
var reg_tel = /^\d{2,3}-\d{3,4}-\d{4}$/;

// 정규 표현식 패턴을 검사하는 함수
// 사용법 : if(!regTest(reg_email, "#email", "leelj1@nate.com 형식의 이메일")) return false;
