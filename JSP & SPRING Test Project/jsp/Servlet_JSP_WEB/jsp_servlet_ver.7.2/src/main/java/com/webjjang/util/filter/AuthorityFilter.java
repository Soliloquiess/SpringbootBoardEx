...
//		}
	...
	public void init(FilterConfig fConfig) throws ServletException {
		...
		pageGradeMap.put("/image/updateForm.do", 1);
		pageGradeMap.put("/image/update.do", 1);
		pageGradeMap.put("/image/updatePhoto.do", 1);
		pageGradeMap.put("/image/delete.do", 1);
		// 메시지 게시판
		pageGradeMap.put("/message/list.do", 1);
		pageGradeMap.put("/message/view.do", 1);
		pageGradeMap.put("/message/writeForm.do", 1);
		pageGradeMap.put("/message/write.do", 1);
		pageGradeMap.put("/message/delete.do", 1);
//		pageGradeMap.put("/ajax/msgCount.do", 1);
	}
