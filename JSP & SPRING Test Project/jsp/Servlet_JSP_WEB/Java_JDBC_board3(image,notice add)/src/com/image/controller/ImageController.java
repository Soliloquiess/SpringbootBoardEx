...
//import com.image.service.ImageDeleteService;
//import com.image.service.ImageListService;
//import com.image.service.ImageUpdateService;
//import com.image.service.ImageViewService;
//import com.image.service.ImageWriteService;
import com.image.service.*; // service 패키지 안에 있는 모든 클래스를 다 import 한다. : * - 모두 다를 의미 한다.
import com.image.vo.ImageVO;
import com.main.controller.Controller;
import com.main.controller.ExeService;
import com.print.ImagePrint;
		...
		while(true) {
			try {
				...
				case "1":
					// List<ImageVO>
					// 1. DB에서 데이터 가져오기
					List<ImageVO> list = (List<ImageVO>) ExeService.execute(new ImageListService(), null);	//이미지 서비스 생성해서 넣어주면 실행 도도
				...
				case "2":
					...
					// 2. 데이터 출력하기
					ImagePrint.print(vo);	//여기서 vo는 이미지 vo. 변수이름만 같는게 아니라 타입도 같아야 
					break;
				case "3":
