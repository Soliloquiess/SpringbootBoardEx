	...
	<div class="container">
		...
		<table class="table">
	     ...
	     개별 태그에 style 속성을 설정하면 가장 먼저 적용이 된다. -->
			...
			<tr>
				<th>이미지</th>
				<td><img src="${vo.fileName }" alt="${vo.title }"
		...
		<div class="modal-dialog">
			...
			<form action="updatePhoto.do" method="post"
				...
				<input type="hidden" name="perPageNum"
					...
					name="word" value="${pageObject.word }"> <input
					type="hidden" name="del" value="${vo.fileName }">
      		 ...
      		 BS : Modal class="close" 닫힘 디자인, data-dismiss="modal" 클릭하면 모달이 닫힌다. -->
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="no">이미지 번호</label> <input type="text"
								class="form-control" id="no" name="no" readonly
								value="${vo.no }">
						</div>
						<div class="form-group">
							<label for="imageFile">변경할 이미지</label> <input type="file"
