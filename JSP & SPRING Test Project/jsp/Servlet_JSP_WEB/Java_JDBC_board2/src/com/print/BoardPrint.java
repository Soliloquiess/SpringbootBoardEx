...
public class BoardPrint {
	...
	public static void print(List<BoardVO> list) {	//매개변수가 리스트일 떄 실행함.
		// 한줄로 출력되는 문자의 반복횟수
		int cnt = 50;
		// 제목 출력
	...
	public static void print(BoardVO vo) {	//매개변수가 BoardVO일 때 실행함.
		// 한줄로 출력되는 문자의 반복횟수
		int cnt = 50;
		// 제목 출력
	...
	public static void print(int result, String msg) {	//매개변수가 result, msg일 때 실행함.
		// 한줄로 출력되는 문자의 반복횟수
		int cnt = 50;
		// 제목 출력
		Output.title(msg);
